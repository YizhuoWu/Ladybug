...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String SUMMARY_COL_1 = "summary_date",SUMMARY_COL_2 = "overall_state",SUMMARY_COL_3 = "food",SUMMARY_COL_4 = "sleep",SUMMARY_COL_5 = "stress",SUMMARY_COL_6 = "exercise", SUMMARY_COL_7 = "cycle_len_change", SUMMARY_COL_8 = "recommendations";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + TABLE_NAME_SUMMARY + " (summary_date TEXT PRIMARY KEY,overall_state TEXT ,food TEXT ,sleep TEXT,stress TEXT,exercise TEXT,cycle_len_change INTEGER, recommendations TEXT) ");
